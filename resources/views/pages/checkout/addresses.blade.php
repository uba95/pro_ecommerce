    ...
    {{-- <form class="needs-validation" novalidate> --}}
      @foreach ($addresses as $address)
        <div class="custom-control custom-radio">
          ...
          <label class="custom-control-label text-muted font-weight-bold mb-1" style="word-spacing: 10px" for="{{'billing_address'.  $address->id }}">
      ...
      {{-- <form class="needs-validation" novalidate> --}}
        @foreach ($addresses as $address)
          <div class="custom-control custom-radio">
            ...
            <label class="custom-control-label text-muted font-weight-bold mb-1" style="word-spacing: 10px" for="{{'shipping_address_'.  $address->id }}">
              {{  ucwords($address->alias)}},
              {{  ucwords($address->address_1) }},
              {{  ucwords($address->address_2) }},
              {{  ucwords($address->city) }},
