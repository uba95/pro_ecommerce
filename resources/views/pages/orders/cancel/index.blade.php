...
<div class="col-lg-8 card">
                    ...
                    <td class="col d-flex">
                        <div class="dropdown " style="cursor: pointer">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-menu-{{ $request->id }}">
                                ...
                                <a class="dropdown-item px-1" href ='{{ route('cancel_orders.show', $request->id) }}'>
                                ...
                                @if ($request->status == 'pending')
                                    <form method="POST" action='{{ route('cancel_orders.destroy', $request->id) }}' class="dropdown-item px-1 deleteWithoutAjax">
                                        @csrf @method('DELETE') 
    ...
    @else
    <div class="alert alert-danger mt-5">No Cancel Order Requests Yet.</div>
    @endif
</div>
@endsection