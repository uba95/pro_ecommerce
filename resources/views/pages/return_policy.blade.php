...
<div class="container py-5">
  ...
  <h3>Return and Refund Policy</h3>
      <div>
        ...
        <p>Thank you for shopping at Ecommerce.</p>
        <p>If, for any reason, You are not completely satisfied with a purchase We invite You to review our policy on refunds
          and returns
        </p>
        ...
        <ul>
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to Ecommerce, 81580 Mariano Vista Lake Trent, VA 41460.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Ecommerce, accessible from <a href="ec.test"
                rel="external nofollow noopener" target="_blank">ec.test</a></p>
          </li>
          <li>
      ...
      <h4>Your Order Cancellation Rights</h4>
        ...
        <p>The deadline for cancelling an Order is 30 days from the date on which You received the Goods or on which a third
          party you have appointed, who is not the carrier, takes possession of the product delivered.
        </p>
        <p>In order to exercise Your right of cancellation, You must inform Us of your decision by means of a clear statement.
          You can inform us of your decision by:</p>
        <ul>
          <li>
            <p>By email: john@doe.com</p>
          </li>
          <li>
            <p>By visiting this page on our website: <a href="http://ec.test/contact" rel="external nofollow noopener"
                target="_blank">http://ec.test/contact</a></p>
          </li>
          <li>
            <p>By phone number: 18557914041</p>
          </li>
          <li>
            <p>By mail: 81580 Mariano Vista Lake Trent, VA 41460</p>
          </li>
        </ul>
      ...
      <h4>Conditions for Returns</h4>
        ...
        <p>We reserve the right to refuse returns of any merchandise that does not meet the above return conditions in our
          sole discretion.</p>
        <p>Only regular priced Goods may be refunded. Unfortunately, Goods on sale cannot be refunded. This exclusion may not
          apply to You if it is not permitted by applicable law.
        </p>
    
      <h4>Returning Goods</h4>
        <p>You are responsible for the cost and risk of returning the Goods to Us. You should send the Goods at the following
          address:</p>
        <p>81580 Mariano Vista Lake Trent, VA 41460</p>
        <p>We cannot be held responsible for Goods damaged or lost in return shipment. Therefore, We recommend an insured and
      ...
      <h4>Gifts</h4>
        <p>If the Goods were marked as a gift when purchased and then shipped directly to you, You'll receive a gift credit
          for the value of your return. Once the returned product is received, a gift certificate will be mailed to You.</p>
        <p>If the Goods weren't marked as a gift when purchased, or the gift giver had the Order shipped to themselves to give
          it to You later, We will send the refund to the gift giver.</p>
        <h5>Contact Us</h5>
